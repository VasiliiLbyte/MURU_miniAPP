...
ALTER TABLE products ADD COLUMN IF NOT EXISTS weight_grams INTEGER NOT NULL DEFAULT 3000;
ALTER TABLE products ADD COLUMN IF NOT EXISTS dim_length_cm INTEGER NOT NULL DEFAULT 22;
ALTER TABLE products ADD COLUMN IF NOT EXISTS dim_width_cm INTEGER NOT NULL DEFAULT 12;
ALTER TABLE products ADD COLUMN IF NOT EXISTS dim_height_cm INTEGER NOT NULL DEFAULT 18;
...
-- web catalog placements (см. migrations/015_web_catalog_placements.sql)
